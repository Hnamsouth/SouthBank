...
!function(n) {
    ...
    var e, n, p, o, r, h, f, g, m, v, y, s, i, _, a, a = ((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? n = u : u = {},
        g = {},
        m = {},
        v = {},
        y = {},
        ...
        h = function(e, t) {
            ...
            return e = i[1],
            o && (n = x(o = l(o, t))),
                o ? e = n && n.normalize ? n.normalize(e, (s = t,
                        function(e) {
                            return l(e, s)
                        }
                )) : l(e, t) : (o = (i = c(e = l(e, t)))[0],
                    e = i[1],
                o && (n = x(o))),
                {
                    f: o ? o + "!" + e : e,
        ...
        e = n = r = function(e, t, n, s, i) {
            ...
            if (!e.splice) {
                if ((v = e).deps && r(v.deps, v.callback),
                    !t)
                    return;
                t.splice ? (e = t,
                    t = n,
            ...
            "function" == typeof n && (n = s,
                s = i),
                s ? o(p, e, t, n) : setTimeout(function() {
                    o(p, e, t, n)
                }, 4),
                r
        }
        ...
        u.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(n, s, i) {
            ...
            return s.Extend(o, s.Observable),
                ...
                s.prototype.convertToOptions = function(e) {
                    ...
                    for (var o = 0; o < e.length; o++) {
                        ...
                        0 <= s.indexOf(l.id) ? (r = n.filter(function(e) {
                            ...
                            a = c.extend(!0, {}, l, a),
                            a = this.option(a),
                            r.replaceWith(a)) : (a = this.option(l),
        ...
        u.define("select2/defaults", ["jquery", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/selectionCss", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./dropdown/dropdownCss", "./dropdown/tagsSearchHighlight", "./i18n/en"], function(l, o, r, a, c, u, d, p, h, f, g, t, m, v, y, _, b, w, $, x, A, D, S, O, L, E, C, T, q, I, e) {
            ...
            return n.prototype.apply = function(e) {
                var t;
                null == (e = l.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = y : null != e.data ? e.dataAdapter = v : e.dataAdapter = m,
                ...
                null == e.resultsAdapter && (e.resultsAdapter = o,
                ...
                null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = a : e.selectionAdapter = r,
            ...
            return e.prototype.fromElement = function(e) {
                ...
                for (var i = 0; i < e[0].attributes.length; i++) {
                    var o = e[0].attributes[i].name
                        , r = "data-";
                    o.substr(0, r.length) == r && (o = o.substring(r.length),
                        r = u.GetData(e[0], o),
        ...
        u.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(t, i, o, s) {
            ...
            return o.Extend(r, o.Observable),
            ...
            function s(e) {
                ...
                0 !== r || 0 !== o)
                    return 1 === n.deltaMode ? (i *= t = u.data(this, "mousewheel-line-height"),
                        r *= t,
                        o *= t) : 2 === n.deltaMode && (i *= t = u.data(this, "mousewheel-page-height"),
                        r *= t,
                        o *= t),
