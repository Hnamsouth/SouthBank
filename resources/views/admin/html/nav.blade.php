    ...
    <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin6">
        ...
        <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item d-none d-md-block search-box">
                <a class="nav-link d-none d-md-block waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
                    ...
                    <div class="mega-dropdown-menu row">
                        ...
                        <div class="col-lg-3 col-xlg-4 mb-4">
                            ...
                            <ul class="list-style-none">
                                <li>
                                    <a href="#" class="font-weight-medium"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle feather-sm text-success me-2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                                        You can give link</a>
                                </li>
                                <li>
                                    <a href="#" class="font-weight-medium"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle feather-sm text-success me-2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end mailbox dropdown-menu-animate-up">
                    <ul class="list-style-none">
                        ...
                        <li>
                            <div class="message-center notifications position-relative ps-container ps-theme-default" style="height: 230px" data-ps-id="5ba0c3ef-4cb4-50c7-67fb-30adbe96d19e">
                                <!-- Message -->
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu mailbox dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="2">
                    <ul class="list-style-none">
                        ...
                        <li>
                            <div class="message-center message-body position-relative ps-container ps-theme-default" style="height: 230px" data-ps-id="fe11d9f6-2edb-f455-a368-84832801b765">
                                <!-- Message -->
                                <a href="javascript:void(0)" class="
                            message-item
                            d-flex
