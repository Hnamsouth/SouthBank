        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert.png" alt="alert" class="img-fluid model_img" id="sa-basic">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert2.png" alt="alert" class="img-fluid model_img" id="sa-title">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert5.png" alt="alert" class="img-fluid model_img" id="model-error-icon">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert3.png" alt="alert" class="img-fluid model_img" id="sa-success">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert4.png" alt="alert" class="img-fluid model_img" id="sa-warning">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert2.png" alt="alert" class="img-fluid model_img" id="sa-html">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert.png" alt="alert" class="img-fluid model_img" id="sa-position">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title">Custom animation</h4>
                        <h6 class="card-subtitle">(Click on image)</h6>
                    </div>
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert7.png" alt="alert" class="img-fluid model_img" id="sa-animation">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/model.png" alt="alert" class="img-fluid model_img" id="sa-confirm">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert6.png" alt="alert" class="img-fluid model_img" id="sa-passparameter">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert7.png" alt="alert" class="img-fluid model_img" id="sa-image">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/model.png" alt="alert" class="img-fluid model_img" id="sa-bg">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert5.png" alt="alert" class="img-fluid model_img" id="sa-autoclose">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert6.png" alt="alert" class="img-fluid model_img" id="sa-rtl">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert.png" alt="alert" class="img-fluid model_img" id="sa-ajax">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title">With Chaning Modals</h4>
                        <h6 class="card-subtitle">(Click on image)</h6>
                    </div>
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert2.png" alt="alert" class="img-fluid model_img" id="sa-chain">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="border-bottom title-part-padding">
                        <h4 class="card-title">With Dynamic Queue</h4>
                        <h6 class="card-subtitle">(Click on image)</h6>
                    </div>
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert3.png" alt="alert" class="img-fluid model_img" id="sa-queue">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert4.png" alt="alert" class="img-fluid model_img" id="sa-timerfun">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <img src="../../assets/images/alert/alert6.png" alt="alert" class="img-fluid model_img" id="sa-close">
                    </div>
                </div>
            </div>
        </div>
...
@section('after-js')
    ...
    <script src="../../dist/js/pages/forms/sweetalert2/sweet-alert.init.js"></script>
@endsection
